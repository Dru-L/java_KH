...
public class Practice {
	...
	public static void example01() {
		...
		int year = 2023;
		int age = 36;
		System.out.println("현재 " + year + "년이고, 나는 올해 " + age + "살 입니다.");
	...
	public static void example02() {
		...
		boolean break_ = true;
		System.out.println("논리형 자료형 변수인 break 의 값은 " + break_ + "입니다.");
	...
	public static void example04() {
		...
		System.out.println("해당 놀이기구는 " + WEIGHT + "키로 이상 탑승 금지!");
	}
	 ...
	 *  2) 자료형의 크기에 상관 없이 (정수) 자료형보다 (실수) 자료형이 우선된다.
	 */
	...
	public static void example06() {
		...
		Scanner sc = new Scanner(System.in); //사용자 입력을 받기 위해 선언 (한번 선언하면 모든 값 저장 가능)
		
		// 사용자로부터 키 입력 받기
		double height; //키를 보관하기 위한 변수
		height = sc.nextDouble(); // 사용자 입력받은 값을 변수에 보관(대입)
		...
		// 화면에 결과 출력 (예시 참고)
		//System.out.printf("내가 원하는 키는 %.2fcm이고, 몸무게는 %dkg입니다.", height, weight);
		System.out.println("내가 원하는 키는 " + height + "cm이고, 몸무게는 " + weight + "kg 입니다.");
	...
	public static void main(String[] args) {
		...
		System.out.print("1~10까지 중 하나만 입력하세요:");
