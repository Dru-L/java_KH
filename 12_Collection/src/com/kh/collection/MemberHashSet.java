...
public class MemberHashSet {
	//내부 접근만 허용한 HashSet<Member>타입의 hashSet멤버변수 선언
	...
	public static void main(String[] args) {
		...
		//클래스 객체가 매개변수면, 인자 값으로는 "인스턴스(생성)" 전달해야한다.
		memberHS.addMember(new Member(1000,"이강인"));
		Member m1 = new Member(1001,"손흥민");
		memberHS.addMember(m1); //m1이 전달되는 것은 new Member(1001, "손흥민")을 전달되는 것과 동일
//		memberHS.addMember("김남길"); // 잘못된 접근 방법!
		...
		memberHS.printMember();
		System.out.println("----------------");
		
		memberHS.addMember(new Member(1001, "손흥민"));
		memberHS.printMember();
	}
