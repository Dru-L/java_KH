...
public class E_Predicate {
	/*
	 * Predicate
	 * 	- Predicate 함수적 인터페이스는 매개변수와 논리값을 리턴하는 test() 추상 메소드를 가지고있다.
	 * 	- test() 추상 메소드는 매개값을 받아서 true/false 를 리턴하는 역할을 한다.
	 */
	public void method1() {
		...
		System.out.println(predicate.test(student1)); //true
		System.out.println(predicate.test(student2));  //false
