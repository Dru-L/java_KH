...
public class D_Operator {
	/*
	 * Operator
	 * 	- Operator  함수적 인터페이스는 매개값과 리턴값이 있는 apply() 추상 메소드를 가지고있다.
	 * 	- apply() 추상 메소드 주로 매개값을 이용해서 연산하고 연산하고  동일한 타입으로 결과를 리턴하는 역학을 한다.
	 */
...
//	         return a+b;    // 매개변수와 동일한 타입으로 리턴해준다.
//	      };
...
//	      };
	      ...
	      binaryOperator =  (Student s1, Student s2) -> {
	    	  return s1.getMathScore() > s2.getMathScore() ? s1 : s2;
	      };
