...
public class Practice {
	...
	public static void example01() {
		...
		//num += 7L; -> long 자료형은 값 뒤에 L을 붙여서 표현. 복합 연산자는 자동으로 명시적 형 변환을 해줌
		
		
		// 결과 출력해주기
		//  출력 예) 입력 값 5에 7L을 더한 결과는 12 입니다.
		System.out.println("입력 값" + num + "에 7L를 더한 결과는 " + (num += 7L) + "입니다.");
	...
	public static void example02() {
		...
		// 위 출력문의 결과? 미성년자
		// 번외) 위에서 사용된 삼항 연산자 부분은? ((age >= 20) ? "성인" : "미성년자")
		//      해석은? 나이가 20보다 같거나 크면 참으로 "성인"을 출력하고, 20보다 작으면 거짓이므로 "미성년자"를 출력하세요.
		...
		//	중학생 나이 범위 체크
		grade = (age >= 14) && (age <= 16) ? "중학생" : grade;
		// 	고등학생 나이 범위 체크
		grade = (age >= 17) && (age <= 19) ? "고등학생" : grade;
		// 화면에 출력 예시: "나이가 18살이면 고등학생 입니다."
		System.out.println("나이가 " + age + "살이면 " + grade + "입니다.");
